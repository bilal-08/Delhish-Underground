...
<div className="w-[60px] h-screen bg-white shadow-sm border-r-[1px] border-[#dbdbdb] fixed  bottom-0 flex flex-col justify-around items-center max-sm:flex-row max-sm:w-full max-sm:h-16 max-sm:border-t-[1px]">
